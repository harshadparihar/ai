...
"rule3": "If the employee shows initiative and takes on additional responsibilities, add 15 points to their
score.",
...
of 0 or 1: "))),"initiative_taken": bool(int(input("Enter the performance of initiative taken in terms of 0 or 1: "))),
