...
if (fScore < gScore[v]) {
gScore[v] = fScore;
pq.add(new Node(v, fScore));}}}}System.out.println("No path found from " + start + " to " + end);}
...
System.out.print("Enter the starting and the ending vertex where you want to find the shortest
distance: ");
